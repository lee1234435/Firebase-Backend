...
model = YOLO('auto_qc_model.pt')  # 코랩에서 학습 후 모델 (코랩해서 학습해서 신호등 초록, 빨강색 구분 모델용)
...
class USBCamera(QWidget):
    ...
    def initUI(self):
        ...
        # frame_1.setLayout(self.)
        frame_2.setLayout(self.info_layout)
        frame_3.setLayout(self.left_layout)
        frame_4.setLayout(self.right_layout)
        ...
        self.main_layout.addWidget(spliter_3)
